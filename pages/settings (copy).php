...
<h2>Analytics Settings</h2>
    ...
    <!-- Google API Settings >> Options Form -->
        ...
        <?php
        // showing access code form if formtype == code
        if($formtype == 'code'){
            ?>
        <!-- Google Access Code -->
        <form method="post" name="formAccessCode">
            ...
            <table class="form-table">
                ...
                <tr>
                    <td colspan="2"><h2>Google Access Code</h2></td>
                </tr>
                <tr>
                    <td colspan="2"><a href="<?php echo $authUrl; ?>" target="_blank">Click here</a> to obtain your Google Access Code</td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="submit" name="access-code-submit" class="btn btn-success" value="Save and Connect"/>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <?php
        } //end if $formtype == "code"
        ?>
        <?php
        // showing api credentials form if formtype is api
        if($formtype == 'api'){
            ?>
        <!-- Google Access Code -->
        <form method="post" name="formOwnCredentials">
            ...
            <table class="form-table">
                ...
                <tr>
                    <td colspan="2"><h2>API Credentials</h2></td>
                </tr>
                <tr>
                    <th>
                        API Key:
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="api-redirect-url" class="regular-text" style="width: 70%;" readonly
    ...
    <form method="post">
        ...
        <table class="form-table ga-web-property-wrapper">
            ...
            <tr>
                <th></th>
                <td>
                    <input type="submit" value="Save Analytics Profile" class="btn btn-success"/>
                </td>
            </tr>
            </tbody>
        </table>
